...
This parameter specifies whether the B<Net::BGP::Peer> will attemt to
...
The RESET and ESTABLISHED callbacks are special, since they are 
used whenever an established BGP
